  ...
  return (
    <div className='w-full flex items-center justify-center my-5'>
      <form className='w-full md:w-1/3 p-4 flex flex-col' onSubmit={(e)=>{submitForm(e)}}>
            ...
            <button className=' bg-fuchsia-800 text-white text-xl font-semibold py-2 mt-4 rounded-full' type='submit'>Sign Up</button>
            <button className=' bg-blue-600 text-white text-xl font-semibold py-2 mt-4 rounded-full flex items-center justify-center' type='submit'><FaGoogle className='mr-5'/>Sign Up With Google</button>
