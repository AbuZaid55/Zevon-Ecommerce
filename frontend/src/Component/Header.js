  ...
  return (
    <div id="header" className={` ${(props.path==='/products')?'fixed top-0 left-0 ':''} z-50 w-full bg-white top-0 h-36`}>
      ...
      <div className="flex items-center justify-between h-20 sm:px-8 px-2 border-b border-fuchsia-950">
        ...
        {/* section2 */}
      <div className="relative sm:static flex flex-col sm:flex-row items-center justify-between sm:px-5 border-b border-fuchsia-950">
        <div className=" w-full sm:hidden flex item-center justify-end px-4 text-2xl bg-fuchsia-800 py-2 text-white"><FaBars className=" cursor-pointer" onClick={()=>{setDropdown(!dropdown)}}/></div>
